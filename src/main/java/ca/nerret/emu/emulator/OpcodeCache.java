...
public final class OpcodeCache {
    ...
    static {
        ...
        _OPCODES.put(0x64, new OpCodeAD2W(0x44, "AD2W"));
        _OPCODES.put(0x65, new OpCodeAD2W(0x45, "AD2W"));
        _OPCODES.put(0x66, new OpCodeAD2W(0x46, "AD2W"));
        _OPCODES.put(0x67, new OpCodeAD2W(0x47, "AD2W"));
